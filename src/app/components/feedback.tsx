...
const People = ({ src, text, name, style = {}, isSmall }: IPeople) => (
  <div className="home_people_wrap">
    ...
    <Flex
      vertical
      style={{
        borderRight: "1px solid var(--main-biege-color)",
        padding: "0 25px",
        ...style,
      }}
    >
      ...
      />} */}
      <Paragraph style={{ fontFamily: "Calibri, sans-serif" }}>
        {text}
      </Paragraph>
      <Paragraph
  ...
  return (
    <Flex className="home_feedbacks" justify="space-around">
      ...
      <People
        ...
        name={t("feedback.madeleine.name")}
        text={t("feedback.madeleine.text")}
        isSmall={isSmall}
      />
       <People
        src="/feedbacks/feedback4.png"
        name={t("feedback.vicdan.name")}
        text={t("feedback.vicdan.text")}
        isSmall={isSmall}
      />
      <People
