...
const images = [
  ['/2d-dimension/0.jpg', '/2d-dimension/1.jpg', '/2d-dimension/2.jpg'],
  ['/2d-dimension/3.jpg', '/2d-dimension/4.jpg', '/2d-dimension/5.jpg'],
  ['/2d-dimension/6.jpg', '/2d-dimension/7.jpg', '/2d-dimension/8.jpg'],
];
      ...
      >
        ...
        >
          <Title
            ...
            level={2}
          >
            {t('service.2dDim.title').toUpperCase()}
          </Title>
          ...
          >
            {t.rich('service.2dDim.description', {
              br: () => <br />,
            })}
          </Paragraph>

          <Flex style={{ width: isSmall ? '100%' : '70%', margin: '30px 0' }} justify='center'>
            <Price price={25} rooms='price.rooms1' />
            <Price price={50} rooms='price.rooms2' highlight />
            <Price price={75} rooms='price.rooms3' />
          </Flex>
        ...
        <Flex vertical align='flex-start' style={{ width: isSmall ? '80%' : '' }}>
          <TextWrap>
            {t('service.2dDim.listItem1')}
          </TextWrap>
          <TextWrap>
            {t('service.2dDim.listItem2')}
          </TextWrap>
          <TextWrap>
          ...
          <TextWrap style={{ margin: '20px 0' }}>
            {t('service.2dDim.listItem5')}
          </TextWrap>
        </Flex>

        <Steps
          title='service.2dDim.instructionTitle'
          steps={[
            'service.2dDim.step1',
            'service.2dDim.step2',
            'service.2dDim.step3'
